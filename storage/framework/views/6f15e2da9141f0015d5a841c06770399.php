...
<head>
    <title>Register|Kehadiran Pengurusan Sekolah Kebangsaan Sungai Sireh</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
                ...
                <div class="card my-5">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-end mb-4">
                            <h3 class="mb-0"><b>Daftar Akaun</b></h3>
                            <a href="login" class="link-primary">Anda sudah mempunyai akaun?</a>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label">Sahkan Kata Lauan</label>
                                    <input type="password" name="password_confirmation" class="form-control "
                                        placeholder="Sahkan Kata Lauan">
                                </div>
                                <p class="mt-4 text-sm text-muted">Dengan Mendaftar, anda bersetuju dengan kami punya <a
                                        href="#" class="text-primary"> Syarat Perkhidmatan </a> and <a
                                        href="#" class="text-primary">
                                        Dasar Privasi</a></p>
                                <div class="d-grid mt-3">
                                    <button type="submit" class="btn btn-primary">Cipta Akaun</button>
                                </div>
                        </form>
                        <div class="saprator mt-3">
                            <span>Mendaftar Dengan</span>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <div class="d-grid">
                                ...
                                <div class="d-grid">
                                    <a href="<?php echo e(url('login/google')); ?>">
                                        <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                                            <img src="<?php echo e(asset('template/dist')); ?>/assets/images/authentication/google.svg"
                                ...
                                <div class="theme-color themepreset-color theme-layout">
                                    <a href="#!" class="active" onclick="layout_change('light')"
                                        data-value="false"><span><img
                                                src="<?php echo e(asset('template/dist')); ?>/assets/images/customization/default.svg"
                                                alt="img"></span><span>Light</span></a>
                                    <a href="#!" class="" onclick="layout_change('dark')"
                                        data-value="true"><span><img
                                                src="<?php echo e(asset('template/dist')); ?>/assets/images/customization/dark.svg"
                            ...
                            <div class="pct-content">
                                <div class="theme-color preset-color">
                                    <a href="#!" class="active" data-value="preset-1"><span><img
                                                src="<?php echo e(asset('template/dist')); ?>/assets/images/customization/theme-color.svg"
                            ...
                            <div class="pct-content">
                                <div class="theme-color themepreset-color boxwidthpreset theme-container">
                                    ...
                                    <a href="#!" class="" onclick="change_box_container('true')"
                                        data-value="true"><span><img
                                                src="<?php echo e(asset('template/dist')); ?>/assets/images/customization/container.svg"
...
<?php /**PATH C:\xampp\htdocs\FYP1\school-attendance-system\resources\views/auth/register.blade.php ENDPATH**/ ?>