    ...
    <div class="">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo e(route('guru.index')); ?>">Kembali</a>
                </div>
            </div>
            <div class="card=body">
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('nama_guru')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $bahagians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bahagian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($bahagian->id); ?>"
                                    <?php echo e(old('bahagian_id') == $bahagian->id ? 'selected' : ''); ?>>
                                    <?php echo e($bahagian->nama_bahagian); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                            value="<?php echo e(old('no_telefon')); ?>">
...
<?php echo $__env->make('layouts.mantis', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP1\school-attendance-system\resources\views/guru/create.blade.php ENDPATH**/ ?>