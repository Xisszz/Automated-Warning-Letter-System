...
@section('content')
    ...
    <div class="card">
        ...
        <div class="text-center mb-4">
            <img src="{{ asset('template/dist/assets/images/Skss1.png') }}" alt="Logo" class="img-fluid mx-auto d-block"
                style="max-width: 150px;">
        </div>

        <div class="text-center">
            <img src="{{ asset('template/dist/assets/images/bangunan.png') }}" alt="Bangunan"
