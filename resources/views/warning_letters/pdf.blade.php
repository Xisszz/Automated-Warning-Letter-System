...
<body>
    ...
    <div class="letter-header">
        ...
        <p>Tarikh Dikeluarkan: {{ $letter->issued_date }}</p>
    </div>

    <div class="content">
        <p><strong>Kepada:</strong> {{ $letter->murid ? $letter->murid->nama_murid : 'Tiada Nama Pelajar' }}</p>
        <p><strong>Kelas:</strong> {{ optional($letter->murid->bahagian)->nama_bahagian ?? '—' }}</p>

        <div class="letter-body">
            <p class="subject">Perkara: Surat Amaran untuk Tingkah Laku Tidak Terkawal</p>

            <p class="warning-content">
                Yang Dikasihi {{ $letter->murid ? $letter->murid->nama_murid : 'Pelajar' }},

                <br><br>
                Surat ini dikeluarkan sebagai amaran rasmi berkaitan dengan tingkah laku yang tidak terkawal yang telah
                anda tunjukkan pada {{ $letter->issued_date }}. Pihak sekolah sentiasa berusaha untuk mengekalkan
        ...
        <div class="footer">
            <p>&copy; {{ date('Y') }} Sekolah Kebangsaan Sungai Sireh. Hak Cipta Terpelihara.</p>
        </div>
    </div>
</body>
